...
<div class="container">
        <div class="row justify-content-center">
          ...
          This is how others will learn about the Product, so make it good!
                        ...
                        <textarea class="form-control" name="description" id="exampleFormControlTextarea1" rows="6">{{$product->description}}"</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <img alt="Image placeholder" src="{{asset('uploads/'.$product->main_image)}}" style ="max-height:200px;">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <img alt="Image placeholder" src="{{asset('uploads/gallery_images/'.$image->path)}}" style ="max-height:200px;">
                        </div>
                        @endforeach
                        </div>
              ...
              If you are available for hire outside of the current situation, you can encourage others to hire you.
                ...
                <i class="fe fe-alert-triangle"></i> Warning
                    ...
                    <button class="btn btn-primary my-5" type="submit">Update {{$product->name}}</button>
